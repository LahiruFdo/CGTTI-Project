...
<body class="body">
	...
	<div class="pageArea">
		...
		<div class="form-area" style="background-color:#fff; height:auto; width:43.5%;margin-top:0%; margin-left: 15%; padding-bottom:3%;">
			...
			<div class="list">
				<dt><div class="form-fields1" style="width:38%;">Main Job Section</div><div class="form-dots2">:</div></dt>
				<dd><div class="form-inputs1" style="width:55%;"><?php echo $mainsec; ?></div></dd>
			</div><br>
			<div class="list">
			...
			<div class="list">
				<dt><div class="form-fields1" style="width:38%;">Start Date</div><div class="form-dots2">:</div></dt>
				<dd><div class="form-inputs1" style="width:55%;"><?php echo $sDate; ?></div></dd>
			</div><br>
			<div class="list">
				<dt><div class="form-fields1" style="width:38%;">Finish Date</div><div class="form-dots2">:</div></dt>
				<dd><div class="form-inputs1" style="width:55%;"><?php echo $fDate; ?></div></dd>
			</div><br>
			</dl>
		</div>
		
		<div id = "g1" class="button-action1"><p>Send Message to</p><p>the Sub-Job Section</p></div>
		<a href="#" style="text-decoration: none; color:black"><div id = "b1" class="round-button1" style="margin-left: 52%;">fafaf</div></a>
		<a href="Sub-Job-Details(PDF).php?id=$SjobNo" target="_blank" style="text-decoration: none; color:black"><div id = "b2" class="round-button2" style="margin-left: 52%;">fafaf</div></a>
