	...
	<div class="pageArea">
		...
		<div id="NewMsg" class="message-area">
			<div class="read-area">
				...
				<form action="../sendMsg.php" method="POST">
					...
					<div class="dropdown" style="margin-top:4%; margin-left:36%;">
		...
		<?php
			if(isset($_GET['id'])){
				...
				$sqlQ = "SELECT fr,t,mDate,content,type,mTime FROM messages WHERE ((fr='$sec' AND t='$msgSec') OR (t='$sec' AND fr='$msgSec')) ORDER BY mDate ";
						...
						if($msgRow['type']=='normal'){
							echo 	"<div class='message-box'>
										<div class='message-box-from'><P>".$msgRow['content']."</P>
											<div class='date-from'>".$msgRow['mDate']." -- ".$msgRow['mTime']." </div>
										</div>		
								   </div>";
						}
							...
							echo 	"<div class='message-box'>
										<div class='message-box-from'><P style='color:rgb(236,104,118);'>".$msgRow['content']."</P>
											<div class='date-from' style='color:#fff'>".$msgRow['mDate']." -- ".$msgRow['mTime']." </div>
										</div>		
								   </div>";
						}
					}
						...
						if($msgRow['type']=='normal'){
							echo 	"<div class='message-box'>
										<div class='message-box-to'><P>".$msgRow['content']."</P>
											<div class='date-to'>".$msgRow['mDate']." -- ".$msgRow['mTime']." </div>
										</div>	
									</div>";
						}
						else if ($msgRow['type']=='notification') {
							echo 	"<div class='message-box'>
										<div class='message-box-to'><P style='color:rgb(236,104,118);'>".$msgRow['content']."</P>
											<div class='date-to' style='color:#fff'>".$msgRow['mDate']." -- ".$msgRow['mTime']." </div>
										</div>	
									</div>";
						}
					}
