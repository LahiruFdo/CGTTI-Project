...
<body class="body">
	...
	<div class="container" style="background-color:  #fbf4db ;">
		<div class="sidebar" style="padding-top:3%;">
			...
			<br>
			<img src="images/pic1.png" style="width:80%;height:30%; margin-left:10%; margin-top:15%; ">
		</div>
		<div class="content" style="background-color:  #fbf4db ;">
			...
			<div class="home">
				<div class="homeDetails">
					...
					<img src="images/cgtti1.jpg" alt="CGTTI Image" style="width:100%;height:30%; box-shadow: 5px 5px 2px #ccc; -webkit-box-shadow: 3px 3px 1px #ccc; -moz-box-shadow: 3px 3px 1px #ccc;">
					<br><br>
				...
				<div class="newsArea">
					...
					<div class="nContents"> <?php echo "Recently added news : ";?> 
							<br><br>sfusgosgnosvo s sog
							gsgsg
					</div>
				</div>
