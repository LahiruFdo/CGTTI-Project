		...
		<div class="searchResults">
			<div class="profInfo">
				<?php
					$num1 = $num;
					$num2 = $num1+10;
					$sql = "SELECT job_typ, job.job_no, subjob.subjob_no, subjob.rDate, subjob.finish_date, subjob.fr  FROM job, subjob, jobservce WHERE ( job.job_no = jobservce.job_no AND job.job_no = subjob.job_no AND subjob.t = '$sec_code' AND subjob.start_date IS NOT NULL ) ORDER BY subjob.start_date DESC LIMIT $num1,10 ";	
