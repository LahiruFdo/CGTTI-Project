...
<body class="body">
	...
	<div class="pageArea" style="font-family: 'calibri','verdana'; padding-right:2%; padding-left:1.5%;">
		...
		<div class="searchResults">
			<div class="profInfo">
				<?php
					$sql = "SELECT job_typ, job.job_no, subjob.subjob_no, subjob.rDate, subjob.finish_date, subjob.start_date, subjob.t  FROM job, subjob, jobservce WHERE ( job.job_no = jobservce.job_no AND job.job_no = subjob.job_no AND subjob.fr = '$sec_code' AND job.job_no LIKE '%$input%') ORDER BY subjob.start_date DESC";	
