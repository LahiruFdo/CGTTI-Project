...
<body class="body">
	...
	<div class="pageArea" style="font-family: 'calibri','verdana'; padding-right:2%; padding-left:1.5%;">
		...
		<div class="searchResults">
			<div class="profInfo">
				<?php
					$sql = "SELECT start_date, finished_date, rDate, job_typ, job.job_no FROM job, jobservce WHERE ( job.job_no = jobservce.job_no AND jobservce.sec_code = '$sec_code' AND jobservce.job_no LIKE '%$input%') ORDER BY job.start_date DESC";	
