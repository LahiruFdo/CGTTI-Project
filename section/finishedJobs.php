...
<body class="body">
	...
	<div class="pageArea" style="font-family: 'calibri','verdana'; padding-right:2%; padding-left:1.5%;">
		<form action="finishedJobs2.php" method="GET">
		...
		<div class="searchResults">
			<div class="profInfo">
				<?php
					$num1 = $num;
					$num2 = $num1+10;
					$sql = "SELECT start_date, finished_date, rDate, job_typ, job.job_no FROM job, jobservce WHERE ( job.job_no = jobservce.job_no AND jobservce.sec_code = '$sec_code' AND job.finished_date IS NOT NULL) ORDER BY job.finished_date DESC LIMIT $num1,10 ";	
					...
					if ($result = mysqli_query($conn,$sql)) {
						...
						if($count >0){
					    	...
					    	while($row = mysqli_fetch_assoc($result)) {
					     	...
					     	echo "</table>";
					     	if($count==10){echo "<div class='links'><a href='finishedJobs.php?id=$num2'><u>View More</u></a></div>";}}
					 	else {
					     	echo "<center>No finished Jobs</center>";
					    }
					}
				?>
