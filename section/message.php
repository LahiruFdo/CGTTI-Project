<?php
	...
	$sqlQ0 = "SELECT ID,fr FROM messages WHERE ( t='$s' AND readBy='F' AND ( type='normal' OR type='notification'))";
	...
	<div class="pageArea">
		...
		<div id="NewMsg" class="message-area">
			<div class="read-area">
				...
				<form action="../sendMsg.php" method="POST">
					...
					<input type="hidden" name="from" value="<?php echo $s;?>">
		...
		<?php
			if(isset($_GET['id'])){
				...
				$sqlQ = "SELECT fr,t,mDate,content,type FROM messages WHERE ((fr='$s' AND t='$msgSec') OR (t='$s' AND fr='$msgSec')) ORDER BY mDate ";
